...
/**
 * La Forêt — Fusion du Réseau : Pouls de la Forêt, moyennes mondiales, initiés publics (liens vers Carte d'Initié).
 */
export default function VueForet({ pulse, onBack }) {
  ...
  return (
    ...
    >
      ...
      <p className="text-[#F1F1E6]/70 text-sm">
        Pouls du Réseau, statistiques mondiales et initiés dont la Constellation est visible. Cliquez pour voir leur Carte d'Initié.
      </p>

      {/* Pouls de la Forêt (contenu ex-Réseau) */}
      <section
      ...
      {/* Hyphes actives — initiés publics (liens vers profile) */}
      <section
